...
if(isset($_POST['MM_insert']) && $_POST['MM_insert'] == "AddForm"){
  $sql= "INSERT INTO category (TypeZone, CategoryName, CreatedDate) VALUES (:TypeZone, :CategoryName, :CreatedDate)";
  $sth = $db ->prepare($sql);
          ...
          <div class="col-md-12">
            <form class="form-horizontal" role="form" action="create.php" method="post" id="AddForm">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="TypeZone" name="TypeZone">
                </div>
              </div>
              <div class="form-group">
                <div class="col-sm-2">
